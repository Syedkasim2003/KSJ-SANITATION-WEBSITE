      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-white/10 pt-16 pb-12">
        <div className="lg:col-span-5">
          ...
          <div className="flex gap-4">
            {[FaFacebook, FaInstagram, FaTwitter, FaLinkedin].map((Icon, i) => (
              <a key={i} href="#home" className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center hover:bg-secondary hover:text-white transition-all duration-300 text-gray-400">
                <Icon size={20} />
              </a>
            ))}
          </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 font-body text-gray-400">
              <li><a href="#services" className="hover:text-secondary transition-colors">Plumbing</a></li>
              <li><a href="#services" className="hover:text-secondary transition-colors">Sanitary Setup</a></li>
              <li><a href="#services" className="hover:text-secondary transition-colors">Drainage</a></li>
              <li><a href="#services" className="hover:text-secondary transition-colors">Maintenance</a></li>
            </ul>
          </div>
          <div className="col-span-2 md:col-span-1">
            <h4 className="text-lg font-bold mb-6 text-white">Legal</h4>
            <ul className="space-y-4 font-body text-gray-400">
              <li><a href="#footer" className="hover:text-secondary transition-colors">Privacy Policy</a></li>
              <li><a href="#footer" className="hover:text-secondary transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
      </div>
